function template() {
    var template = [
        '<div id="template" class="card event-card">',
                    ...
                    '</div>',
                    '<div id="size-indicator" class="event-size-indicator-huge"></div>',
                        ...
                        '<div class="card-btn-container">',
                            ...
                            '<div class="dropup-container">',
                                '<div class="dropup div-inline">',
                                   ...
                                   '</button>',
                                    '<div class="dropdown-menu dropdown-menu-r                                        '<a class="interest-item not-interested">Not Interested</a>',
                                        '<a class="interest-item interested">Interested</a>',
ight" aria-labelledby="dropdownMenuButton">',
