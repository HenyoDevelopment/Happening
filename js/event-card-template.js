    ...
    var template = [
        '<div id="1" class="card event-card">',
                    '<div class="card-header">',
                        ...
                        '</div>',
                        '<div id="event-host" class="header-text"><a class="user">moonrise</a></div>',
                    '</div>',
                    '<div class="img-container vertical-align">',
                        '<img id="event-image" class="card-event-img" src="" alt="">',
                    '</div>',
                    ...
                    '<div class="card-block">',
                        '<div class="card-text-container">',
                            ...
                            '<p id="event-date-time" class="card-event-info"></p>',
