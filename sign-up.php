            ...
            <div class="login-container col-sm-4 col-sm-offset-4">
                    ...
                    <div id="exTab3">	
                        <ul class="nav nav-pills center-pills">
                            <li class="active"><a href="#1b" data-toggle="tab">Sign Up</a></li>
                        </ul>
                        <div class="tab-content clearfix">
                            <div class="tab-pane active" id="1b">
                                <div class="text-container">
                                    <h4 id="top-text">Happening is launching soon at</h4> 
                                    <h4 id="school">University of Maryland</h4>
                                ...
                                -->
                                <form name="sign-up-form" action="php-helper/sign-up-validation2.php" method="post" onSubmit="return validateForm()">
                                    ...
                                    <div class="btn-holder">
                                        <input id="submit-btn" type="submit" name="submit" value="Reserve My Username!">
                                    </div>
                                </form>
                                <!--SIGN UP FORM END-->
                            </div>
